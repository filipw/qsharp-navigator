...
(() => {
  ...
  // ../npm/qsharp/dist/compiler/common.js
  function outputAsResult(msg) {
    try {
      const obj = JSON.parse(msg);
      if ((obj == null ? void 0 : obj.type) == "Result" && typeof obj.success == "boolean") {
        return {
          type: "Result",
          result: {
            success: obj.success,
  ...
  function outputAsMessage(msg) {
    try {
      const obj = JSON.parse(msg);
      if ((obj == null ? void 0 : obj.type) == "Message" && typeof obj.message == "string") {
        return obj;
      }
    } catch (e) {
      return null;
  ...
  function outputAsDump(msg) {
    try {
      const obj = JSON.parse(msg);
      if ((obj == null ? void 0 : obj.type) == "DumpMachine" && typeof obj.state == "object") {
        return obj;
      }
    } catch (e) {
      return null;
  ...
  function outputAsMatrix(msg) {
    try {
      const obj = JSON.parse(msg);
      if ((obj == null ? void 0 : obj.type) == "Matrix" && Array.isArray(obj.matrix)) {
        return obj;
      }
    } catch (e) {
      return null;
  ...
  // ../npm/qsharp/dist/compiler/events.js
  ...
  // ../npm/qsharp/dist/compiler/compiler.js
  var Compiler = class {
    constructor(wasm2) {
    ...
    async getDocumentation(additionalProgram) {
      return this.wasm.generate_docs(additionalProgram && toWasmProgramConfig(additionalProgram, "unrestricted"));
    }
  ...
  // ../npm/qsharp/dist/compiler/worker-browser.js
  var messageHandler = createWorker(compilerProtocol);
